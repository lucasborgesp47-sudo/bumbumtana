      ...
      <div className="max-w-md mx-auto">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {step === 7 && (
              <div className="bg-white p-8 rounded-3xl border shadow-xl text-center space-y-6">
                <h2 className="text-2xl font-bold text-primary">🎯 Seu Protocolo Personalizado está pronto!</h2>
                <div className="text-left space-y-2 bg-slate-50 p-4 rounded-xl border border-slate-100">
